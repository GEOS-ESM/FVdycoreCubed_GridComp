...
contains
   ...
   subroutine make_fv_flags_C_interop(fv_flags, layout, c_fv_flags)
      ...
      c_fv_flags%full_zs_filter = merge(.true._c_bool, .false._c_bool, fv_flags%full_zs_filter)
      c_fv_flags%rf_fast = merge(.true._c_bool, .false._c_bool, fv_flags%RF_fast)
      c_fv_flags%Beljaars_TOFD = merge(.true._c_bool, .false._c_bool, fv_flags%Beljaars_TOFD)
      c_fv_flags%consv_am = merge(.true._c_bool, .false._c_bool, fv_flags%consv_am)
      c_fv_flags%do_sat_adj = merge(.true._c_bool, .false._c_bool, fv_flags%do_sat_adj)
      c_fv_flags%do_f3d = merge(.true._c_bool, .false._c_bool, fv_flags%do_f3d)
      c_fv_flags%no_dycore = merge(.true._c_bool, .false._c_bool, fv_flags%no_dycore)
      c_fv_flags%convert_ke = merge(.true._c_bool, .false._c_bool, fv_flags%convert_ke)
      c_fv_flags%do_vort_damp = merge(.true._c_bool, .false._c_bool, fv_flags%do_vort_damp)
      c_fv_flags%use_old_omega = merge(.true._c_bool, .false._c_bool, fv_flags%use_old_omega)
      ...
      c_fv_flags%warm_start = merge(.true._c_bool, .false._c_bool, fv_flags%warm_start)
      c_fv_flags%inline_q = merge(.true._c_bool, .false._c_bool, fv_flags%inline_q)
      c_fv_flags%adiabatic = merge(.true._c_bool, .false._c_bool, fv_flags%adiabatic)
      c_fv_flags%shift_fac = fv_flags%shift_fac
      c_fv_flags%do_schmidt = merge(.true._c_bool, .false._c_bool, fv_flags%do_schmidt)
      ...
      c_fv_flags%reset_eta = merge(.true._c_bool, .false._c_bool, fv_flags%reset_eta)
      ...
      c_fv_flags%use_logp = merge(.true._c_bool, .false._c_bool, fv_flags%use_logp)
      c_fv_flags%q_split = fv_flags%q_split
      c_fv_flags%print_freq = fv_flags%print_freq
      c_fv_flags%write_3d_diags = merge(.true._c_bool, .false._c_bool, fv_flags%write_3d_diags)
      ...
      c_fv_flags%nudge_dz = merge(.true._c_bool, .false._c_bool, fv_flags%nudge_dz)
      ...
      c_fv_flags%filter_phys = merge(.true._c_bool, .false._c_bool, fv_flags%filter_phys)
      c_fv_flags%dwind_2d = merge(.true._c_bool, .false._c_bool, fv_flags%dwind_2d)
      c_fv_flags%breed_vortex_inline = merge(.true._c_bool, .false._c_bool, fv_flags%breed_vortex_inline)
      c_fv_flags%range_warn = merge(.true._c_bool, .false._c_bool, fv_flags%range_warn)
      c_fv_flags%fill = merge(.true._c_bool, .false._c_bool, fv_flags%fill)
      c_fv_flags%fill_dp = merge(.true._c_bool, .false._c_bool, fv_flags%fill_dp)
      c_fv_flags%fill_wz = merge(.true._c_bool, .false._c_bool, fv_flags%fill_wz)
      c_fv_flags%check_negative = merge(.true._c_bool, .false._c_bool, fv_flags%check_negative)
      c_fv_flags%non_ortho = merge(.true._c_bool, .false._c_bool, fv_flags%non_ortho)
      c_fv_flags%moist_phys = merge(.true._c_bool, .false._c_bool, fv_flags%moist_phys)
      ...
      c_fv_flags%mountain = merge(.true._c_bool, .false._c_bool, fv_flags%mountain)
      c_fv_flags%old_divg_damp = merge(.true._c_bool, .false._c_bool, fv_flags%old_divg_damp)
      c_fv_flags%remap_option = fv_flags%remap_option
      c_fv_flags%gmao_remap = fv_flags%gmao_remap
      c_fv_flags%z_tracer = merge(.true._c_bool, .false._c_bool, fv_flags%z_tracer)
      c_fv_flags%fv_land = merge(.true._c_bool, .false._c_bool, fv_flags%fv_land)
      c_fv_flags%nudge = merge(.true._c_bool, .false._c_bool, fv_flags%nudge)
      c_fv_flags%nudge_ic = merge(.true._c_bool, .false._c_bool, fv_flags%nudge_ic)
      c_fv_flags%ncep_ic = merge(.true._c_bool, .false._c_bool, fv_flags%ncep_ic)
      c_fv_flags%nggps_ic = merge(.true._c_bool, .false._c_bool, fv_flags%nggps_ic)
      c_fv_flags%ecmwf_ic = merge(.true._c_bool, .false._c_bool, fv_flags%ecmwf_ic)
      c_fv_flags%gfs_phil = merge(.true._c_bool, .false._c_bool, fv_flags%gfs_phil)
      c_fv_flags%agrid_vel_rst = merge(.true._c_bool, .false._c_bool, fv_flags%agrid_vel_rst)
      c_fv_flags%use_new_ncep = merge(.true._c_bool, .false._c_bool, fv_flags%use_new_ncep)
      c_fv_flags%use_ncep_phy = merge(.true._c_bool, .false._c_bool, fv_flags%use_ncep_phy)
      c_fv_flags%fv_diag_ic = merge(.true._c_bool, .false._c_bool, fv_flags%fv_diag_ic)
      c_fv_flags%external_ic = merge(.true._c_bool, .false._c_bool, fv_flags%external_ic)
      c_fv_flags%external_eta = merge(.true._c_bool, .false._c_bool, fv_flags%external_eta)
      c_fv_flags%read_increment = merge(.true._c_bool, .false._c_bool, fv_flags%read_increment)
      c_fv_flags%do_skeb = merge(.true._c_bool, .false._c_bool, fv_flags%do_skeb)
      c_fv_flags%skeb_npass = fv_flags%skeb_npass
      c_fv_flags%hydrostatic = merge(.true._c_bool, .false._c_bool, fv_flags%hydrostatic)
      c_fv_flags%phys_hydrostatic = merge(.true._c_bool, .false._c_bool, fv_flags%phys_hydrostatic)
      c_fv_flags%use_hydro_pressure = merge(.true._c_bool, .false._c_bool, fv_flags%use_hydro_pressure)
      c_fv_flags%do_uni_zfull = merge(.true._c_bool, .false._c_bool, fv_flags%do_uni_zfull)
      c_fv_flags%hybrid_z = merge(.true._c_bool, .false._c_bool, fv_flags%hybrid_z)
      c_fv_flags%Make_NH = merge(.true._c_bool, .false._c_bool, fv_flags%Make_NH)
      c_fv_flags%make_hybrid_z = merge(.true._c_bool, .false._c_bool, fv_flags%make_hybrid_z)
      c_fv_flags%nudge_qv = merge(.true._c_bool, .false._c_bool, fv_flags%nudge_qv)
      ...
      c_fv_flags%adj_mass_vmr = merge(.true._c_bool, .false._c_bool, fv_flags%adj_mass_vmr)
      c_fv_flags%compute_coords_locally = merge(.true._c_bool, .false._c_bool, fv_flags%compute_coords_locally)
