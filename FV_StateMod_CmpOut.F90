...
! Convience variables
  ...
  type(ESMF_VM) :: vm
  integer :: comm, rank, mpierr, irank, nranks
  ...
  character(len=*), parameter :: fmt_e = '(i4, 1x, a1, 1x, a8, 1x, a1, 1x, es19.9, 1x, a1, 1x, es19.9)'
  character(len=*), parameter :: fmt_e1 = '(i4, 1x, a1, 1x, a8, 1x, a1, 1x, es19.9, 1x, a1, 1x, es19.9, 1x, a)'
  character(len=*), parameter :: fmt_e2 = '(i4, 1x, a1, 1x, a8, 1x, a1, 1x, es19.9, 1x, a1, 1x, es19.9, 1x, a1, 1x, i2)'
   ...
   if ( check_mass .OR. fix_mass ) then
    ...
    do irank = 0, nranks-1
       if (irank == rank) then
          ...
          call abs_err_3d(FV_Atm(1)%diss_est(is:ie, js:je, :), diss_est_tmp(is:ie, js:je, :), err_linf, err_l2)
